...
// export default function StatisticsChart_KPI_3() {
...
//        const res = await fetch(`http://localhost:8000/kpi_3?Plant=CHENNAI&Material=${selectedFilter.Material}&ViewType=${viewType}`);
//        const data: StockChangeData[] = await res.json();
//        setRawData(data);
//        console.log("Recieved KPI 3 Chart Data : ", data)
//        setTimeout(() => {
//          setShowChart(true);
//          setIsLoading(false);
//        }, 300);
...
//     weeklyByYear[year][label] = Number(entry["Stock Change"]);
//     labelSet.add(label);
//   });
