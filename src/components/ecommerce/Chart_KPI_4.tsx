...
//     const quantities = rawData.map((d) => Number(d["Return Rate (%)"]));

//     setCategories(dates);
//     setSeries([{ name: "Return Rate (%)", data: quantities }]);
//   }
...
//     setSeries([{ name: "Return Rate (%)", data: combined.map((d) => d.value) }]);
//   }
// }, [selectedTab, rawData]);
