...
const DOHPremiumCard: React.FC<DOHPremiumCardProps> = ({
  daysOnHand,
  ...
  return (
    <div className="relative">
      <div
        className={`relative w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl rounded-3xl overflow-hidden transition-all duration-700 ease-out cursor-pointer backdrop-blur-xl border ${
          isHovered ? 'shadow-2xl scale-[1.008] shadow-blue-100/50' : 'shadow-xl scale-100 shadow-gray-100/30'
        } ${className}`}
        style={{
          background: `
